...
#include "../../Wiring/propertiesdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PropertiesDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 70, 32)
    },
    "PropertiesDialog\0on_buttonBox_accepted\0"
    "\0on_outlineColorButton_clicked\0"
...
void PropertiesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_outlineColorButton_clicked(); break;
        case 2: _t->on_backgroundColorButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject PropertiesDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PropertiesDialog.data,
      qt_meta_data_PropertiesDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PropertiesDialog.stringdata))
